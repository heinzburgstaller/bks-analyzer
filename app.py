...
known = {
  ...
  "Lebensmittel": ["SPAR DANKT", "BILLA DANKT", "LIDL DANKT", "ADEG", "AGM", "PENNY", "BASIC AUSTRIA", "FRESSNAPF", "BAECKEREI", "BACKEREI"],
  ...
  "Einrichtung": ["XXXLUTZ", "IKEA", "JYSK", "THALIA.AT", "DEPOT HANDELSGESELL", "LAGERHAUS", "S' KAEFERLE", "OBI", "WILLHABEN"],
  ...
  "Kredit": ["KREDITRATE"],
  "Amazon": ["AMAZON.DE", "AMZN MKTP", "AMZ*"],
  ...
  "Spotify/Netflix/Prime/Nintendo": ["PAYPAL *SPOTIFY", "SPOTIFY", "NETFLIX", "AMZNPRIME", "AMAZON PRIME", "NINTENDO"],
  "Paypal": ["PAYPAL"],
}
